...
from tkinter import * #Smporting everything from tkinter#
    ...
    if usrnm == "":#If username is empty#
        ...
        if pswd == "":#If password is empty#
            ...
            if pswd == password[usr_usrnm]:#When user given password match password of username's index number#
                ...
                mb.showwarning("Password Incorrect","1Please check your password")#Message box warning#
        else:
            mb.showwarning("Password Incorrect","2Please check your password")#Message box warning#
    else:
        mb.showwarning("Username Incorrect","3Please check your username")#Message box warning#
    
#Show login frame only#
login_frame()
...
#Continue button#
ctnbtn = tk.Button(dtlframe,fg="white",bg="#1ba1e2",font=("Arial",22),text="Continue")
