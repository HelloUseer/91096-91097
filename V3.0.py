...
rgstrframe=tk.Frame(window,bg="#dae8fc")
rgstrframe.pack(fill="both",expand=True)
#Creating login frame#
lgnframe=tk.Frame(window,bg="#dae8fc")#expand take as much space as possible, but without fill will not be coloured in#
...
heading = tk.Label(rgstrframe,bg="#dae8fc",font=("Arial",26),text="Register For Library Book Finder")
heading.place(x=280,y=100)

#Username Label#
usrnmlbl = tk.Label(rgstrframe,bg="#dae8fc",font=("Arial",20),text="Username")
usrnmlbl.place(x=300,y=200)
#Username entry box#
usrnmreg = tk.Entry(rgstrframe,bg="white")
usrnmreg.place(x=525,y=220)

#Password Label#
pswdlbl = tk.Label(rgstrframe,bg="#dae8fc",font=("Arial",20),text="Password")
pswdlbl.place(x=300,y=280)
#Password entry box#
pswdreg = tk.Entry(rgstrframe,bg="white")
pswdreg.place(x=525,y=280)

#Back Button#
bkbtn = tk.Button(rgstrframe,fg="white",bg="#1ba1e2",font=("Arial",22),text="Back",command=login_frame)
bkbtn.place(x=100,y=400)

#Register Button#
registerbtn = tk.Button(rgstrframe,fg="white",bg="#1ba1e2",font=("Arial",22),text="Register",command=register_chk)
registerbtn.place(x=750,y=400)
...
#Register Button#
regbtn = tk.Button(lgnframe,fg="white",bg="#1ba1e2",font=("Arial",22),text="New Account",command=rgstr_frame)
